...
echo "<table class='wp-list-table widefat fixed striped'>";
    ...
    $percCacheHit = ($stats["get_hits"] / $stats["cmd_get"] *100);
    ...
    $MBRead=  $stats["bytes_read"]/(1024*1024);

    echo "<tr><td>读取字节数</td><td>".$MBRead." Mega Bytes</td></tr>";
    $MBWrite= $stats["bytes_written"]/(1024*1024) ;
    echo "<tr><td>发送字节数</td><td>".$MBWrite." Mega Bytes</td></tr>";
    $MBSize= $stats["limit_maxbytes"]/(1024*1024) ;
